const translations = {
  ...
  productList: {
    ...
    desc: {
      kh: 'កម្រងផលិតផលប្តូរជាប្រចាំ រួមមានជម្រើសស្ទូឌីយ៉ូ ការផលិតចំនួនកំណត់ និងរបស់ចាំបាច់សម័យថ្មី។',
      en: 'A rotating collection of studio favorites, limited runs, and modern essentials.',
    },
    allCategories: {
      kh: 'គ្រប់ប្រភេទ',
      en: 'All categories',
  ...
  adminLogin: {
    ...
    loginDesc: {
      kh: 'បញ្ចូលព័ត៌មានចូលគណនីដើម្បីចូលផ្ទាំងស្ទូឌីយ៉ូគ្រប់គ្រង។',
      en: 'Enter your credentials to access the studio dashboard.',
    },
    email: {
      kh: 'អ៊ីមែល',
      en: 'Email',
  ...
  adminLayout: {
    ...
    operationsStudio: {
      kh: 'ស្ទូឌីយ៉ូប្រតិបត្តិការ',
      en: 'Operations Studio',
    },
    dashboard: {
      kh: 'ផ្ទាំងគ្រប់គ្រង',
      en: 'Dashboard',
  ...
  manageBanners: {
    ...
    imageHelp: {
      kh: 'ជ្រើសរើស JPG, PNG, WebP, GIF, BMP ឬ AVIF។ ប្រព័ន្ធនឹងបង្ហាប់ និងបម្លែងទៅជា WebP ដោយស្វ័យប្រវត្តិ។',
      en: 'Supports JPG, PNG, WebP, GIF, BMP, and AVIF. Images and GIFs are compressed to WebP automatically.',
    },
    mediaHelp: {
      kh: 'គាំទ្រ JPG, PNG, WebP, GIF, BMP, AVIF, MP4, WebM, OGG, MOV។ រូបភាព និង GIF នឹងត្រូវបង្ហាប់/បម្លែងទៅជា WebP ដោយស្វ័យប្រវត្តិ។ Video នឹងរក្សាចលនា។',
      en: 'Supports JPG, PNG, WebP, GIF, BMP, AVIF, MP4, WebM, OGG, and MOV. Images and GIFs are compressed to WebP automatically. Video keeps motion.',
    },
    media: {
      kh: 'មេឌៀ Banner',
      en: 'Banner media',
